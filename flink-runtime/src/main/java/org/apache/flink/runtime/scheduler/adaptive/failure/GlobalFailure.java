...
/** Represents a global failure, i.e., a failure not limited to a part of the ExecutionGraph. */
public class GlobalFailure extends Failure {
    public GlobalFailure(Throwable cause) {
        super(cause);
    }
